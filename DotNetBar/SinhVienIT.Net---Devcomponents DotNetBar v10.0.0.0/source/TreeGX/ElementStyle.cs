...
//		}
		...
		/// </summary>
        [DevCoSerialize(), DefaultValue(eCornerType.Square), Browsable(true), Category("Border"), Description("Indicates border corner type.")]
...
//			es.BackgroundColor=SystemColors.Highlight;
		...
		/// </summary>
		internal ElementStyleCollection Parent
		{
			get {return m_Parent;}
			set {m_Parent=value;}
		}

		private TreeGX m_TreeControl;
		/// <summary>
