...
namespace DevComponents.DotNetBar.Rendering
{
    internal static class VisualStudio2010Factory
    {
        public static void InitializeColorTable(Office2007ColorTable table, ColorFactory factory)
        {
            ...
            table.RibbonControl.InnerBorder = new LinearGradientColorTable(factory.GetColor(0xC9D2E1));
            ...
            table.ComboBox.Default.Border = factory.GetColor(0x8591A2);
            ...
            table.ComboBox.DefaultStandalone.Border = factory.GetColor(0x8591A2);
            ...
            table.TabControl.TabPanelBorder = factory.GetColor(0x8591A2);
            #endregion
            ...
            table.LegacyColors.PanelBorder = factory.GetColor(0x8591A2);
            ...
            #region DataGridView
            table.DataGridView.ColumnHeaderNormalBorder = factory.GetColor(0x8591A2);
            ...
            table.DataGridView.ColumnHeaderMouseOverBorder = factory.GetColor(0x8591A2);
            ...
            table.DataGridView.ColumnHeaderPressedBorder = factory.GetColor(0x8591A2);

            table.DataGridView.RowNormalBackground = new LinearGradientColorTable(factory.GetColor(0xE4ECF7));
            table.DataGridView.RowNormalBorder = factory.GetColor(0x8591A2);
            ...
            table.DataGridView.RowPressedBorder = factory.GetColor(0x8591A2);
            ...
            table.DataGridView.SelectorBorder = factory.GetColor(0x8591A2);
            ...
            table.SideBar.Border = factory.GetColor(0x8591A2);
            ...
            table.WarningBox.WarningBorderColor = factory.GetColor(0x8591A2);
            ...
            {
                new ColorDef(factory.GetColor(0x8591A2)),           // DayViewBorder
            ...
            table.CalendarView.TimeRulerColors = new ColorDef[]
            {
                ...
                new ColorDef(factory.GetColor(0x8591A2)),           // TimeRulerBorder
                new ColorDef(factory.GetColor(0x8591A2)),           // TimeRulerTickBorder
            ...
            {
              new ColorDef(factory.GetColor(0x8591A2)),           // DayOfWeekHeaderBorder
                ...
                new ColorDef(factory.GetColor(0x8591A2)),           // DayHeaderBorder
            ...
            table.StyleClasses.Add(style.Class, style);
            // TextBox border
            style = Office2007ColorTableFactory.GetTextBoxStyle(factory.GetColor(0x8591A2));
            table.StyleClasses.Add(style.Class, style);
            // ItemPanel
            style = Office2007ColorTableFactory.GetItemPanelStyle(factory.GetColor(0x8591A2));
            table.StyleClasses.Add(style.Class, style);
            // DateTimeInput background
            style = Office2007ColorTableFactory.GetDateTimeInputBackgroundStyle(factory.GetColor(0x8591A2));
            table.StyleClasses.Add(style.Class, style);
            // Ribbon Client Panel
            ...
            style = Office2007ColorTableFactory.GetAdvTreeStyle(factory.GetColor(0x8591A2));
            table.StyleClasses.Add(style.Class, style);
